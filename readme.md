...
```bash
npm install --save-dev babel-preset-jaid@^9.0.0
```
...
```bash
yarn add --dev babel-preset-jaid@^9.0.0
```
...
```bash
npm install --save-dev @jaid/babel-preset-jaid@^9.0.0
```
