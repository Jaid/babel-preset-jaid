...
```bash
npm install --save-dev babel-preset-jaid@^8.1.2
```
...
```bash
yarn add --dev babel-preset-jaid@^8.1.2
```
...
```bash
npm install --save-dev @jaid/babel-preset-jaid@^8.1.2
```
