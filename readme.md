...
```bash
npm install --save-dev babel-preset-jaid@^7.3.4
```
...
```bash
yarn add --dev babel-preset-jaid@^7.3.4
```
...
```bash
npm install --save-dev @jaid/babel-preset-jaid@^7.3.4
```
