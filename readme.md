...
```bash
npm install --save-dev babel-preset-jaid@^7.3.6
```
...
```bash
yarn add --dev babel-preset-jaid@^7.3.6
```
...
```bash
npm install --save-dev @jaid/babel-preset-jaid@^7.3.6
```
