...
```bash
npm install --save-dev babel-preset-jaid@^7.3.3
```
...
```bash
yarn add --dev babel-preset-jaid@^7.3.3
```
...
```bash
npm install --save-dev @jaid/babel-preset-jaid@^7.3.3
```
