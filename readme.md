...
```bash
npm install --save-dev babel-preset-jaid@^7.3.5
```
...
```bash
yarn add --dev babel-preset-jaid@^7.3.5
```
...
```bash
npm install --save-dev @jaid/babel-preset-jaid@^7.3.5
```
