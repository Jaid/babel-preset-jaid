...
```bash
npm install --save-dev babel-preset-jaid@^8.0.1
```
...
```bash
yarn add --dev babel-preset-jaid@^8.0.1
```
...
```bash
npm install --save-dev @jaid/babel-preset-jaid@^8.0.1
```
